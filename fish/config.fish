...
alias pyinit "python3 -m venv env; and source env/bin/activate.fish; and pip3 install --upgrade pip yapf ipython jupyterlab pylint requests; and pip3 install -r requirements.txt"
