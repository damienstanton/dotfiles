...
# note for these two logo-ls commands that -D should go back in if its performance can be improved
alias c="clear; logo-ls -1 -g -G -t -h -r -T RFC3339"
alias ca="clear; logo-ls -a -1 -g -G -t -h -r -T RFC3339"
alias ct="clear; logo-ls -R"
